...
?>
<style>
#paypal{width:150px;top: 320px;position:absolute;right:0;}
span.danke {
left:-150px;
position:absolute;
top:-10px;
	...
	<tbody>
		...
		<tr>
			...
			<br class="clear" />
					...
					<span class="danke"><?php _e('A small thank you?'); ?></span>
					<input name="cmd" type="hidden" value="_s-xclick" /> 
<input name="hosted_button_id" type="hidden" value="GEAVFBEECG85G" /> 
<input alt="Jetzt einfach, schnell und sicher online bezahlen – mit PayPal." name="submit" src="http://www.internetdienste-berlin.de/wp-content/uploads/2011/01/Zahlbutton.png" type="image" /> 
