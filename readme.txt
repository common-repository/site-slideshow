...
<li>2.1.1 Fixing minor bugs</li>
<li>2.2.0 Serious bug in context of encapsulation a fixed. Sometimes it caused error messages during image uploading </li>
<li>2.3.0 A bug wasting memory is fixed </li>
